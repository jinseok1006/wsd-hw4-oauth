...
export default function SignIn() {
  ...
  return (
    <div className={cx("container")}>
      <div
        className={cx("form-container", "form-1", {
      ...
      >
        ...
        <div className={cx("padding-wrap")}>
          ...
          <span className={cx("login")}>
            No account?{' '}
            <a id="log-in" onClick={handleSignUp1Submit}>
              Sign up.
            </a>
          </span>
        </div>
      ...
      <div
        className={cx("form-container", "form-2", {
          pull: isForm2Pull,
          push: isForm2Push,
        })}
      >
        ...
        <div className={cx("padding-wrap")}>
          ...
          <span id="back" className={cx("login")}>
            <a onClick={handleBackClick}>Already have an account? </a>
          </span>
        </div>
      </div>
